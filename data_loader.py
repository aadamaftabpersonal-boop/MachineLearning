...
# openml - downloads dataset from the openml repository
# train_test_split - creates training and testing datasets
# StandardScaler - standardizes features
# LabelEncoder- converts categorical labels to integers
# 
# load_openml_df():
# downloads dataset from OpenML and returns it as a pandas DF
# #